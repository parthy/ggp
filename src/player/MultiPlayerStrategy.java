...
public class MultiPlayerStrategy extends AbstractStrategy {
	...
	public IMove getMove(IGameNode arg0) {
		...
		try {
			...
			if(best == null || (turntaking && this.noop_name != null && this.noop_name != "" && best.getMoves() != null && best.getMoves()[playerNumber].getMove() != null && best.getMoves()[playerNumber].getMove().equals(this.noop_name))) { // we didn't find anything.. (actually not possible)
				return game.getRandomMove(arg0)[playerNumber];
			}
